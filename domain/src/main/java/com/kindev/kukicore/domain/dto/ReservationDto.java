...
public class ReservationDto {
    ...
    @JsonProperty("lodgementReserved")
    private LodgementForReservationDto lodgementReserved;
    ...
    public LodgementForReservationDto getLodgementReserved() {
        return lodgementReserved;
    }

    public void setLodgementReserved(LodgementForReservationDto lodgementReserved) {
